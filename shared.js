// Cabinet MAHBOULI — Shared nav + footer injector
(function () {
...
<footer class="footer">
  <div class="footer-grid">
    <div class="f-brand">
      ...
      <div class="footer-social">
        ...
        <a href="#" aria-label="Facebook"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M22 12a10 10 0 10-11.55 9.88V14.9H8v-2.9h2.45V9.84a3.41 3.41 0 013.65-3.76 14.84 14.84 0 012.16.19v2.38H15.1c-1.19 0-1.56.74-1.56 1.5V12h2.66l-.43 2.9h-2.23v6.98A10 10 0 0022 12z"/></svg></a>
      </div>
    </div>
    <div>
  ...
  <div class="footer-bottom">
    <span>© <span class="yr"></span> Cabinet d'avocats MAHBOULI — Tous droits réservés</span>
    <div class="links">
